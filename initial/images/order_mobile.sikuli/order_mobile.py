def shop():
    ...
    type ("http://wwwdev.globe.com.ph/shop.html") 
    ...
    wait(2)
def mobile():
    while not exists("1534412303889.png"):
        wait(1)
    click("1534412303889.png")
    while not exists("postpaid.png"):
        wait(1)
    click("postpaid.png")
    while not exists("1534469547673.png"):
        wait(1)
    type(Key.PAGE_DOWN*1)
    while not exists("samsung_plus_gear.png"):
        wait(1)
    click("samsung_plus_gear.png")
def addToCard():
